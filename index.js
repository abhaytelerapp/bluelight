...
// module.exports = fs.readFileSync(path.join(__dirname, "html/start.html"), "utf8");
module.exports = `
<!DOCTYPE html>
<html>
...
<body style="background-color:#000000;" onmousewheel="/*return false;*/">
  ...
  <div style="display: flex; align-items: center; justify-content: space-between;">
    ...
    <div style="margin-top: 13px;">
      <img class="" alt="Report Editor" loading="lazy" id="reportEditor"
        src="../image/icon/lite/edit-patient.png" style=" filter: invert(80%);" width="40" height="40">
    </div>
  </div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div style="display: flex; align-items: center; gap: 12px;">
                <input type="file" id="fileInput" style="font-size: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem; padding-right: 0.75rem; padding-left: 0.75rem; width: 100%;" accept=".pdf, .png, .jpg, .doc, .docx, .mp4">
                <button onclick="uploadDocument()" style="font-size: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem; padding-right: 0.75rem; padding-left: 0.75rem;">Upload</button>
              </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-buttons">
            <button id="saveButton"  style="font-size: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem; padding-right: 0.75rem; padding-left: 0.75rem;" onclick="handleClinicalHistoryChange()">Save</button>
